...
def plot_gather(fig_handle, input_ensemble, output_ensemble):
    ...
    im1 = ax1.imshow(numpy.transpose(input_ensemble), clim=(-5000,5000), cmap="binary", aspect="auto", interpolation='None')
    ...
    im2 = ax2.imshow(numpy.transpose(output_ensemble), clim=(-5000,5000), cmap="binary", aspect="auto", interpolation='None')
    ...
    im3 = ax3.imshow(numpy.transpose(input_ensemble - output_ensemble), clim=(-1000,1000), cmap="binary", aspect="auto", interpolation='None')
